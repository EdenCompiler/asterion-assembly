...
# Os assets versionados são os mesmos nas duas plataformas. Empacotar não os regenera.
...
cp "$raiz/docs/MANUAL.md" "$raiz/docs/MODDING.md" "$raiz/docs/API.md" "$raiz/docs/UPGRADE-3.md" "$raiz/docs/PLAYTEST-3-2026-09-06.md" "$pacote/docs/"
